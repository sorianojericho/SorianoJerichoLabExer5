...
public class AndroidAdapter extends ArrayAdapter<com.example.sorianojericholabexer5.AndroidVersion> {
    private Context context;
    private int resource;

    public AndroidAdapter(Context context, int resource, List<com.example.sorianojericholabexer5.AndroidVersion> objects) {
